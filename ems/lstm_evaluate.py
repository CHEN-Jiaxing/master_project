...
p_bat_list = np.load('./p_lstm.npy')* 1000
...
print(SOC_list[-1])
'''
np.save("./fcon_lstm.npy", fuel_consumption_list)
np.save("./deg_lstm.npy", fc_deg_list)
np.save("./eff_lstm.npy", fc_eff_list)
np.save("soc_lstm", SOC_list)
np.save("pfc_lstm", p_fc_list)
np.save("pbat_lstm", p_bat_list)
'''
print("=====END=====")